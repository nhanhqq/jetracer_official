...
The script uses static batch 1, FP16, `224x224`, and a 512 MiB workspace. It also runs a 10-second `trtexec` benchmark. A successful workstation ONNX export is not evidence that the Nano engine is valid until this command succeeds on the actual Nano.
